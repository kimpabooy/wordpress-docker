...
class Foyer_Slide_Formats {
	...
	static function add_fbg1_slide_format( $slide_formats ) {
		 ...
		 * @param	array	$slide_format_backgrounds	The currently available slide backgrounds for this slide format.
		 */
		$slide_format_backgrounds = apply_filters( 'foyer/slides/backgrounds/format=fbg1', $slide_format_backgrounds );

		$slide_formats['fbg1'] = array(
			'title' => _x( 'Falkenberg skolskärm', 'slide-format', 'foyer' ),
			'description' => __( 'Klocka, matsedel text mm.', 'foyer' ),
			'meta_box' => array( 'Foyer_Admin_Slide_Format_Fbg1', 'slide_meta_box' ),
			'save_post' => array( 'Foyer_Admin_Slide_Format_Fbg1', 'save_slide' ),
			'slide_backgrounds' => $slide_format_backgrounds,
		);
		return $slide_formats;
	}
